  ...
  axios
    ...
    .then(function (response) {
      ...
      if (ubicacion === 'Argentina') {
        axios.get("URL-API-ARGENTINA?producto="+ producto + "&cantidad=" + cantidad + "&codigo=" + codigo + "&ubicacion=" + ubicacion)
          .then(function (response) {
        ...
        axios.get("URL-API-INDIA-?producto="+ producto + "&cantidad=" + cantidad + "&codigo=" + codigo + "&ubicacion=" + ubicacion)
          .then(function (response) {
            console.log(response.data);
          })
          .catch(function (error) {
